<header class="bg-slate-400 text-stone-800 navbar-theme relative z-50">
    ...
    <!-- Menu mobile -->
    <div id="mobile-menu"
         class="hidden md:hidden absolute width-menu-mobile-navbar z-50 py-3 bg-slate-400 navbar-theme bg-opacity-90 flex flex-col justify-center text-stone-800 rounded-xl">
